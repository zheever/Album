...
namespace Album
{
    ...
    public sealed partial class GamePage : Page
    {
        ...
        private int _max_round = 4;

        public GamePage()
        {
            this.InitializeComponent();
            Songs = new ObservableCollection<Song>();
            this.MyMediaElement.AutoPlay = true;
        }
        ...
        private async Task<ObservableCollection<StorageFile>> SetupMusicList()
        {
            ...
            await RetrieveFilesInFolders(allSongs, Assets);
        ...
        private async Task<List<StorageFile>> PickRandomSongs(ObservableCollection<StorageFile> allSongs, int pickNumber)
        {
            ...
            if (songCount < pickNumber)
            {
                await new MessageDialog("You should have more than " + pickNumber + "songs in your music library..", "Something Wrong").ShowAsync();
                pickNumber = songCount;
                _max_round = (songCount / 2 - 1) > 0 ? (songCount / 2 - 1) : 0;
            }
        ...
        private async Task PopulateSongList(List<StorageFile> files)
        {
            ...
            foreach (var file in files)
            {
                ...
                StorageItemThumbnail Thumb = await file.GetThumbnailAsync(
                    ThumbnailMode.MusicView,
                    200,
                    ThumbnailOptions.UseCurrentScale);

                var TrueAlbumCover = new BitmapImage();
                TrueAlbumCover.SetSource(Thumb);
                ...
                song.TrueAlbumCover = TrueAlbumCover;
                song.SongFile = file;
        ...
        private void DisplayCorrectSong(Song correctSong)
        {
            ...
            ResultImage.Source = correctSong.TrueAlbumCover;
        }
        ...
        protected override void OnNavigatingFrom(NavigatingCancelEventArgs e)
        {
            ...
            _playingMusic = false;
            _totalScore = 0;
            this.MyMediaElement.AutoPlay = false;
        }
